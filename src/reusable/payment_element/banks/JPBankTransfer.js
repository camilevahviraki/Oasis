      ...
      <dl>
        ...
        {displayBankTransferInstructions.financial_addresses[0] ? (
          <>
            <dt><b>振込先情報</b></dt>
            <dd>
              {displayBankTransferInstructions.financial_addresses[0].zengin.bank_name}
              {' '}
              (
              {displayBankTransferInstructions.financial_addresses[0].zengin.bank_code}
              )
              <br />
              {displayBankTransferInstructions.financial_addresses[0].zengin.branch_name}
              {' '}
              (
              {displayBankTransferInstructions.financial_addresses[0].zengin.branch_code}
              )
              {' '}
              <br />
              {displayBankTransferInstructions.financial_addresses[0].zengin.account_type === 'futsu'
                ...
                : '当座預金'}
              :
              {displayBankTransferInstructions.financial_addresses[0].zengin.account_number}
              {' '}
              <br />
