                    ...
                    showDateForm ? (
                      <div className="search-categories-list" id="solds-search-categories-list">
                        <form className="search-categories-list-form" onSubmit={handleRangeFilter}>
                          ...
                          <input type="date" id="start_date" onChange={(e) => setStartDate(e.target.value)} max={endDate || yesterdayString} />
                          <label htmlFor="end_date">End date</label>
                          <input type="date" id="end_date" onChange={(e) => setEndDate(e.target.value)} min={startDate || '2022-01-01'} max={today} />
