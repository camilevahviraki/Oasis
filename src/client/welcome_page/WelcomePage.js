...
const WelcomePage = () => {
  ...
  const cardsData = [
    {
      mainTile: <>Welcome in the <span>Oasis</span></>,
      text: "Sell and buy products",
      image: bgImg1,
      bgColor: ['#27374D', 'transparent']
    },
    {
      mainTile: <>Find <span>products</span> around you</>,
      text: "",
      image: bgImg2,
      bgColor: ['#27374D', 'transparent'],
    },
    {
      mainTile: <><span>Create</span> your <span>store</span> in 4 easy <span>steps</span></>,
      text: "",
      image: bgImg3,
      bgColor: ['#27374D', 'transparent'],
    },
    {
      mainTile: <>Find <span>markets</span> in your region</>,
      text: "",
      image: bgImg4,
      bgColor: ['#27374D', 'transparent'],
    },
    {
      mainTile: <>Use <span>delivery</span> services or <span>Locate a store</span> and/or go in person.</>,
      text: "",
      image: bgImg5,
      bgColor: ['#27374D', 'transparent'],
    },
  ...
  return (
    <div className="welcome-page-container">
      <div className="welcome-page-big-cards-container">
      ...
      <div className="welcome-page-footer-container">
        ...
        <p className="welcome-page-footer-licence"><AiOutlineCopyright/>{' '}2023 oasis.com ltd</p>
      </div>
    </div>
  );
};
